...
#path = "/home/ravina/catkin_ws/src/gps_driver/Data/open/stationary/open_stationary.bag"

#Uncomment below line to see : Scatter plot of Occluded stationary
#path = "/home/ravina/catkin_ws/src/gps_driver/Data/occluded/stationary/occluded_stationary.bag"
...
#Known Locations
open1 = [327900, 4686832] # exact location of open space
occluded = [328081, 4689513] # exact location of partially occluded space
...
print("mean_easting", mean_easting)
print("mean_northing", mean_northing)
print("median_easting", median_easting)
print("median_northing", median_northing)
